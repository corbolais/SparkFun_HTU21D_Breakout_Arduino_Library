...
MODs: 2017-TF
- add ID check for HTU21 and SI7021 from SparkFun Si7021 Temperature and Humidity Breakout by Joel Bartlett
- add dew point calculation from Sodaq_SHT2x.cpp by Christopher Ladden
*/
...
/**********************************************************
 * readDewPoint
 *  Reads the current dew point based on the current humidity and temperature
 *
 * @return float - The dew point in Deg C
 **********************************************************/
float HTU21D::readDewPoint(void)
{
